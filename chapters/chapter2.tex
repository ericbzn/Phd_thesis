...
\begin{figure}[!ht] 
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=\textwidth]{rgb_cube}
		\caption{RGB cube}	
		\label{fig:rgb_cube}
	\end{subfigure}
	%add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=\textwidth]{hsv_cone}
		\caption{HSV cone}	
		\label{fig:hsv_cone}
	\end{subfigure}
	%add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=\textwidth]{hls_bicone}
		\caption{HSL bicone}	
...
\begin{figure}[!ht] 
	...
	\caption{Graphic display of tree alternatives to obtain the complex color representation of an image: \captext{(a)} from LAB color space, \captext{(b)} from form HSL color space, and \captext{(c)} from HSV color space.}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[t]{\dimexpr0.32\textwidth+20pt\relax}
    	\makebox[20pt]{\raisebox{40pt}{\captext{(e)}} }%
    ...
    \begin{subfigure}[t]{\dimexpr0.32\textwidth+20pt\relax}
    	\makebox[20pt]{\raisebox{40pt}{\captext{(f)}} }%
    ...
    \begin{subfigure}[t]{\dimexpr0.32\textwidth+20pt\relax}
    	\makebox[20pt]{\raisebox{40pt}{\captext{(g)}} }%
