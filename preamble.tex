...
\usepackage[authoryear,round,semicolon,sort&compress,sectionbib]{natbib}		% Doit être chargé avant babel
...
\usepackage{commath}            % Allow to use the \abs math command
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Tableaux
\usepackage{multirow}
\usepackage{booktabs}
