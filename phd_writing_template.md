...
Hoy en día es un momento emocionante para trabajar en la visión por computadora. Gracias las bases de datos de acceso libre en internet, a los novedosos algoritmos de visión por computadora y, al aumento de la capacidad de cálculo, las máquinas pueden realizar las tareas de visión de una manera más rápida y eficiente que un humano. Además, el acceso a estas tecnologías ha propiciado el desarrollo de novedosas aplicaciones, las cuales favorecen no solo al avance de la visión por computadora, sino también favorece a la sociedad. La visión por computadora se ha convertido en una tecnología integral en nuestra vida diaria.
...
Los vehículos aéreos no tripulados (UAVs) o drones son estas máquinas voladoras que están cada día más presentes en nuestras vidas. La combinación de diferentes sensores de la central inercial, el GPS y el computador de vuelo permiten que los drones se mantengan estables en el aire. No obstante, las capacidades de un dron son extendidas cuando se integra algún tipo de sensor visual. Ya sea en actividades de entretenimiento utilizados como juguetes, o en actividades comerciales utilizados como herramientas de trabajo, los drones nos permiten ver el mundo y obtener información desde otra perspectiva, literalmente. 
...
No obstante, una gran limitante de estos sistemas complejos es el tiempo de autonomía. Este parámetro está ligado principalmente al peso del vehículo, dado por los diferentes componentes a bordo de la aeronave y a la capacidad de la batería, que también influye en el peso final del equipo. En este sentido, es importante privilegiar aquellos sensores que proporcionen información del mundo exterior para la navegación pero también ligeros y de bajo consumo energético. 
...
Tomando esto en cuenta y recordando las áreas de aplicación y tareas de la visión por computadora mencionadas en la sección anterior, este trabajo de tesis se concentrará en aquellas relacionadas con los drones y las tareas de detección de objetos y  comprensión de escenas. En cuanto a las técnicas y métodos de los algoritmos de visión desarrollados, esta tesis explota los ahora llamados métodos tradicionales de visión por computadora, es decir, aquellos algoritmos no basados en arquitecturas de redes neurales y principalmente en métodos no supervisados.
...
Si bien los drones son útiles en una amplia variedad de aplicaciones, tanto comerciales, civiles o militares, en la mayoría de los casos es necesario un piloto experto para controlar la aeronave. La adición de señores tales como el GPS, los ultrasónicos, los lidares o las cámaras ha sido una estrategia recurrente que ha permitido que estos robots aéreos sean más manipulables, más seguros e incluso en algunos casos, autónomos, es decir, que el dron es capaz de realizar una tarea sin necesidad de una intervención humana. Para esto, el dron debe ser capaz de desplazarse sin perderse pero sobre todo, debe ser capaz de evitar los potenciales obstáculos del camino.

While drones are useful in a wide variety of applications, whether commercial, civil or military, in most cases an expert pilot is required to control the aircraft. The addition of gentlemen such as GPS, ultrasonics, lidars or cameras has been a recurring strategy that has made these aerial robots more manipulable, safer and even in some cases, autonomous, that is, that the drone is able to perform a task without the need for human intervention. For this, the drone must be able to move without getting lost but above all, it must be able to avoid potential obstacles on the way.

De manera general, podemos considerar que cada aplicación de drones se trata de una misión que involucra tres principales momentos: 

In general, we can consider that each drone application is a mission.
